  ...
  return (
    <React.StrictMode>
      <Head>
        ...
        <meta name="twitter:site" content="@zilionixx" />
        <meta name="twitter:creator" content="@zilionixx" />
        <meta property="og:url" content="https://crowdsale.zilionixx.com" />
        <meta property="og:title" content="Zilionixx ICO" />
        <meta
        ...
        <meta
          property="og:image"
          content="%PUBLIC_URL%/background-v4@blur.jpg"
        />
      </Head>
      <Banner
        isOpen={isOpenBanner}
